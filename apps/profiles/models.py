...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'),max_length=30,default="+19420420420")
    ...
    city=models.CharField(verbose_name=_('City'),max_length=180,default='Houston',blank=False, null=False)
